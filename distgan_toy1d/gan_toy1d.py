...
class Visualization(object):
    ...
    def plot_progress(self, gan, session, data):
        ...
        if gan.model == 'gan' or gan.model == 'rgan' or gan.model == 'mdgan' or gan.model == 'vaegan' or gan.model == 'distgan':
            title = 'Loss'
        ...
        if gan.model == 'distgan' or gan.model == 'rgan' or gan.model == 'mdgan':
        ...
        if gan.model == 'gan' or gan.model == 'rgan' or gan.model == 'mdgan' or gan.model == 'distgan' or gan.model == 'vaegan':
